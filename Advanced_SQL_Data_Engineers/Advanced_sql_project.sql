...
LEFT JOIN CHICAGO_CENSUS_DATA AS C 
...
LEFT JOIN CHICAGO_CENSUS_DATA AS CEN ON CRI.COMMUNITY_AREA_NUMBER = CEN.COMMUNITY_AREA_NUMBER
WHERE CRI.LOCATION_DESCRIPTION LIKE 'SCHOOL%';

CREATE OR REPLACE VIEW schools_view (School_Name, Safety_Rating, Family_Rating, 
